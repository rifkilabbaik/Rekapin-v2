const CONFIG = {
  ...
  SALES_FIELDS: [
    { key: 'bruto',             header: 'Bruto',             source: 'bruto',             label: { id: 'Bruto',             en: 'Gross' },           table: true },
    { key: 'rataBruto',         header: 'Rata-rata Bruto',   source: 'rata-rata bruto',   label: { id: 'Rata-rata Bruto',   en: 'Avg Gross' },       agg: 'none' },
    { key: 'dineIn',            header: 'Dine In',           source: 'dine in',           label: { id: 'Dine In',           en: 'Dine In' },         group: 'offline', table: true },
    { key: 'dineInCu',          header: 'Dine In CU',        source: 'dine in',           sub: 'cu', label: { id: 'CU Dine In',   en: 'Dine In CU' },  type: 'count' },
    { key: 'takeAway',          header: 'Take Away',         source: 'take away',         label: { id: 'Take Away',         en: 'Take Away' },       group: 'offline', table: true },
    { key: 'takeAwayCu',        header: 'Take Away CU',      source: 'take away',         sub: 'cu', label: { id: 'CU Take Away', en: 'Take Away CU' }, type: 'count' },
    { key: 'shopeeFood',        header: 'ShopeeFood',        source: 'shopeefood',        label: { id: 'ShopeeFood',        en: 'ShopeeFood' },      group: 'online', table: true },
    { key: 'shopeeFoodCu',      header: 'ShopeeFood CU',     source: 'shopeefood',        sub: 'cu', label: { id: 'CU ShopeeFood', en: 'ShopeeFood CU' }, type: 'count' },
    { key: 'goFood',            header: 'GoFood',            source: 'gofood',            label: { id: 'GoFood',            en: 'GoFood' },          group: 'online', table: true },
    { key: 'goFoodCu',          header: 'GoFood CU',         source: 'gofood',            sub: 'cu', label: { id: 'CU GoFood',    en: 'GoFood CU' },   type: 'count' },
    { key: 'grabFood',          header: 'GrabFood',          source: 'grabfood',          label: { id: 'GrabFood',          en: 'GrabFood' },        group: 'online', table: true },
    { key: 'grabFoodCu',        header: 'GrabFood CU',       source: 'grabfood',          sub: 'cu', label: { id: 'CU GrabFood',  en: 'GrabFood CU' }, type: 'count' },
    { key: 'katering',          header: 'Katering',          source: 'katering',          label: { id: 'Katering',          en: 'Catering' },        group: 'catering', table: true },
    ...
    { key: 'mdr',               header: 'Mdr',               source: 'mdr',               label: { id: 'Mdr',               en: 'Mdr' },             table: true },
    { key: 'diskonOnline',      header: 'Diskon Online',     source: 'diskon online',     label: { id: 'Diskon Online',     en: 'Online Discount' }, table: true },
    { key: 'biayaOnline',       header: 'Biaya Online',      source: 'biaya online',      label: { id: 'Biaya Online',      en: 'Online Fee' },      table: true },
    { key: 'biayaPemasaran',    header: 'Biaya Pemasaran',   source: 'biaya pemasaran',   label: { id: 'Biaya Pemasaran',   en: 'Marketing Fee' },   table: true },
    { key: 'diskon',            header: 'Diskon',            source: 'diskon',            label: { id: 'Diskon',            en: 'Discount' },        table: true },
    { key: 'biayaPengemasan',   header: 'Biaya Pengemasan',  source: 'biaya pengemasan',  label: { id: 'Biaya Pengemasan',  en: 'Packaging Fee' },   table: true },
    ...
    { key: 'netto',             header: 'Netto',             source: 'netto',             label: { id: 'Netto',             en: 'Net' },             table: true },
