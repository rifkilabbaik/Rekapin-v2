const CONFIG = {
  ...
  I18N: {
    id: {
      ...
      export_summary_daily: '{n} bagian · {r} baris · {d} tanggal',
      export_meta_channel: 'Channel', export_meta_category: 'Kategori',
    ...
    en: {
      ...
      export_summary_daily: '{n} sections · {r} rows · {d} dates',
      export_meta_channel: 'Channel', export_meta_category: 'Category',
